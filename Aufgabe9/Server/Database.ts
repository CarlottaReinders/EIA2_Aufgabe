...
if (process.env.NODE_ENV == "production") {
    databaseURL = "mongodb+srv://EiA2_testuser:Attolrac98@carlosmongo-yycdq.mongodb.net/StudiVZ";
...
export function searchMatrikelnummer(_matrikel: number, _callback: Function): void {
